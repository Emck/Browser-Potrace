...
function setHtmlAttr(html, attrName, value) {
...
export { luminance, between, clamp, isNumber, setHtmlAttr, renderCurve, bezier, tangent, mod, xprod, cyclic, sign, quadform, interval, dorth_infty, ddenom, dpara, cprod, iprod, iprod1, ddist };
